...
namespace ExitGames
{
	namespace LoadBalancing
	{
		...
		private:
			...
			unsigned short getDefaultPort(nByte serverType);
		...
		bool Client::opRaiseEvent(bool reliable, const Ftype& parameters, nByte eventCode, RaiseEventOptions options)
		{
		...
		template<typename Ftype>
		bool Client::opRaiseEvent(bool reliable, const Ftype pParameterArray, typename Common::Helpers::ArrayLengthType<Ftype>::type arrSize, nByte eventCode, RaiseEventOptions options)
		{
		...
		template<typename Ftype>
		bool Client::opRaiseEvent(bool reliable, const Ftype pParameterArray, const short* pArrSizes, nByte eventCode, RaiseEventOptions options)
		{
